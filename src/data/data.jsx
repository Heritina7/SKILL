...
const donner = [
  {
    ...
    description3: "Intégration d’une API REST avec Axios.",
    description4: "Gestion d’état avec React Hooks.",
    description5: "Optimisation responsive pour mobile et desktop.",
  },
  {
    id: 2,
    ...
    description1: "Mise en place du backend avec Django REST Framework.",
    ...
    description5: "Déploiement du projet sur un VPS Linux.",
  },
    {
    id: 3,
